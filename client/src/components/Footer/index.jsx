      ...
      <div className="container">
        ...
        >
          ...
          <Col className="gutter-row" span={6} xs={24} sm={24} md={12} lg={6}>
            <h2>iTicket</h2>
            <nav>
              <a href="/en/page/about" class="">
                About us
              </a>{" "}
              <a href="/en/venues" class="">
                Venues
              </a>{" "}
              <a href="/en/point-of-sales" class="">
                Point of Sales
              </a>{" "}
              <a href="/en/page/krf" class="">
                Karabakh Revival Foundation
              </a>{" "}
              <a href="/en/page/contacts" class="">
                Contacts
              </a>
            </nav>
          </Col>
          <Col className="gutter-row" span={6} xs={24} sm={24} md={12} lg={6}>
            <h2>Security</h2>
            <p>
              All payments are protected by 3D <br /> Secure from Visa, Visa
              Electron, <br />
              Maestro & MasterCard
            </p>
